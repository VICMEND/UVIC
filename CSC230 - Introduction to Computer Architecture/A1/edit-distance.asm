...
; **** BEGINNING OF "STUDENT CODE" SECTION **** 
	...
	mov  r18, r16 ; place value of r16 in r18 to keep r16 intact
	ldi r25, 0x00 ; set r25 as 0

	eor r18, r17 ; XOR operation on the two numbers resulting in different bits being 1s

loop:
	lsl r18 ; shift the bits with the left most bit going to the carry flag.
	brcs increment ; if a one is found increment
	brne loop ; check if r18 is 0 signifying that all bits have been shifted.
